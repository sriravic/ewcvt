...
function [new_voronoi_tesselations] = EWVT_color(input_image, voronoi_tesselations, generators)
    ...
    while(true)
        ...
        for y = 1 : height
            for x = 1 : width
                edistances = edge_weighted_distance_color(x, y, input_image,voronoi_tesselations, generators, lambda);
